...
DROP TABLE IF EXISTS InjuryExcludedExercise;
...
CREATE TABLE IF NOT EXISTS Subscription (
  ...
  updatedAt DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  FOREIGN KEY (userId) REFERENCES User(id) ON DELETE CASCADE,
  FOREIGN KEY (planId) REFERENCES SubscriptionPlan(planId) ON DELETE RESTRICT
);
...
CREATE TABLE IF NOT EXISTS GymClass (
  ...
  description TEXT DEFAULT NULL,
  requiredPlan VARCHAR(50) NOT NULL DEFAULT 'free',
  createdAt DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updatedAt DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  FOREIGN KEY (trainerId) REFERENCES Trainer(id) ON DELETE SET NULL,
  FOREIGN KEY (requiredPlan) REFERENCES SubscriptionPlan(planId) ON DELETE RESTRICT
);
...
CREATE TABLE IF NOT EXISTS TrainerBooking (
  ...
  updatedAt DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  FOREIGN KEY (userId) REFERENCES User(id) ON DELETE CASCADE,
  FOREIGN KEY (trainerId) REFERENCES Trainer(id) ON DELETE RESTRICT
);
...
CREATE TABLE IF NOT EXISTS Payment (
  ...
  CONSTRAINT chk_payment_source CHECK (
    (trainerBookingId IS NOT NULL) + (classBookingId IS NOT NULL) + (subscriptionId IS NOT NULL) = 1
  )
);
...
CREATE TABLE IF NOT EXISTS AlternativeMeal (
  ...
  fat FLOAT NOT NULL DEFAULT 0,
  createdAt DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  FOREIGN KEY (injuryType) REFERENCES InjuryRestriction(injuryType) ON DELETE RESTRICT
);
...
CREATE TABLE IF NOT EXISTS UserBenefit (
  ...
  benefitKey VARCHAR(50) NOT NULL,
  usedCount INT NOT NULL DEFAULT 0,
  maxCount INT NOT NULL DEFAULT 0,
  expiresAt DATETIME DEFAULT NULL,
  createdAt DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updatedAt DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  UNIQUE KEY unique_subscription_benefit (subscriptionId, benefitKey),
  FOREIGN KEY (subscriptionId) REFERENCES Subscription(id) ON DELETE CASCADE
);
